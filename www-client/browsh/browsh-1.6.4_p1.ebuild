...
EGO_SUM=(
	...
	"github.com/ulule/limiter v2.2.2+incompatible/go.mod"
	...
	"golang.org/x/net v0.0.0-20190607181551-461777fb6f67/go.mod"
...
COMMIT="540882ec8c9e40414de54d6c43f72f861c4e89d9"
MY_PV=$(ver_cut 1-3)
MY_P="${PN}-${MY_PV}"
...
src_compile() {
	go-bindata \
		...
		"${S}/${PN}.xpi" || die "bundling web extension failed"
